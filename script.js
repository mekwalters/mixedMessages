const peopleAndAnimals = ['nuns', 'soccer players', 'dogs', 'ducks', 'lawyers', 'blondes', 'Americans', 'Canadians', 'Russians', 'Jedi', 'Wizards', 'zombies'];
...
console.log ('3 _________ walk into a bar'); //needs people & animals array
